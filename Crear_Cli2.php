        ...
        <form class="clientes" action='crearcliente.php' method='POST'><div class="clientes2">
            ...
            <div class="form-group" align="center">
                <div class="form-group col-md-4" align="center">
                    ...
                    <input type='text' id='txtTelefono' name='txtTelefono' style='text-align:center' placeholder='00000000' required class='form-control input-text' maxlength='8' inputmode='numeric' pattern='[0-9]*' value='<?php echo $telefono ?>'>
