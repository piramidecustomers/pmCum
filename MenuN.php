...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <form action="ListadoClientes.php">
                        <button  type="submit" value="Ver Clientes" class="myButton2" >
                ...
                <form action="ListadoPedidos.php">
                    <button  type="submit" value="Ver Pedidos" class="myButton3">
            ...
            <div class="col">
                <form action='Inicio.php' method='POST'>
                    <button class="myButton" type="submit" value="Buscar Clientes">
                ...
                <form action='Crear_Cli.php' method='POST'>
                    <button  type="submit" value="Buscar Clientes" class="myButton4">
